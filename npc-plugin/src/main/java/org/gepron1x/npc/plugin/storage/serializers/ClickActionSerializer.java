...
public final class ClickActionSerializer implements TypeSerializer<ClickAction> {
	/**
	 ...
	 */
	@Override
	public ClickAction deserialize(Type type, ConfigurationNode node) throws SerializationException {
		return ClickAction.command(node.require(String.class));
	}
	 ...
	 */
	@Override
	public void serialize(Type type, @Nullable ClickAction obj, ConfigurationNode node) throws SerializationException {
