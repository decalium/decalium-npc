...
public interface NpcStorage {
	CompletableFuture<List<NonPlayerCharacter>> loadAll();

	CompletableFuture<NonPlayerCharacter> load(String identifier);

	CompletableFuture<?> save(NonPlayerCharacter npc);
