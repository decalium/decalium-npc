...
//    private static final Reflection.MethodInvoker getNetworkMarkers = Reflection.getTypedMethod(serverConnectionClass, null, List.class, serverConnectionClass);
	...
	protected TinyProtocol(Plugin plugin) {
		this.plugin = plugin;
		...
		endInitProtocol = new ChannelInitializer<Channel>() {
			...
			protected void initChannel(Channel channel) throws Exception {
				try {
					...
					plugin.getSLF4JLogger().error("Cannot inject incomming channel " + channel, e);
				}
			}
	...
	private final class PacketInterceptor extends ChannelDuplexHandler {
		...
		public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
			...
			try {
				...
				plugin.getSLF4JLogger().error("Error in onPacketInAsync()", e);
			}
