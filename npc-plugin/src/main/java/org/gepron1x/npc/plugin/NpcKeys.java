...
public final class NpcKeys {
	...
	public static final NamespacedKey IDENTIFIER = DecaliumNpc.createKey("identifier");
	public static final NamespacedKey NAME_TAG = DecaliumNpc.createKey("nametag");

	public static final NamespacedKey GLOW_COLOR = DecaliumNpc.createKey("glow_color");
}
